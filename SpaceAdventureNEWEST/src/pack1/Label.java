...
public class Label {
	...
	static int gecici2X;
	static int gecici2Y;
	static int astBuyukcarpmaSayýsý=0;
	static int kullandýgýmDeger=0;
	static int toplamSaglýk=1000;
	static int saglýkArttýrma=300;
	static int saglýkAzaltma=500;
